...
set OUTPUT_FILE="ClipCursorDisable_x64.dll"
set INPUT_FILE="ClipCursorDisable.cpp"
...
set OUTPUT_FILE="ClipCursorDisable_x86.dll"
set INPUT_FILE="ClipCursorDisable.cpp"
set LIB_FILES="detours.lib Dbghelp.lib user32.lib"
...
copy LICENSE build\LICENSE.ClipCursorDisable
copy README.md build\README.ClipCursorDisable.md
copy ClipCursorDisable.bat build
copy Detours\bin.X64\setdll.exe build\setdll_x64.exe
copy Detours\bin.X86\setdll.exe build\setdll_x86.exe
move ClipCursorDisable_x64.dll build
move ClipCursorDisable_x86.dll build

REM ===================================================================================================================

REM cleanup build intermediate files
del ClipCursorDisable_x64.exp
del ClipCursorDisable_x86.exp
del ClipCursorDisable_x64.lib
del ClipCursorDisable_x86.lib
del ClipCursorDisable.obj
